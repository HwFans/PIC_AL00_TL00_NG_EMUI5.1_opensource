...
#define    RP_MSG_SIZE                 (RP_MSG_SLOT_NUM * MSG_SLOT_SIZE)
#define    DN_MSG_SIZE                 (DN_MSG_SLOT_NUM * MSG_SLOT_SIZE)
#define    VDM_REG_USED_SIZE           (512)
#define    RP_MSG_USED_SIZE            (RP_MSG_SIZE)
...
#define    ONEMB_PMV_COLMB_ADDR_LEN    (20*4)

//db defines
#define    DB_THR_LEASTBLKDIFF         (0)
