...
HI_S32 VENC_DRV_EflOpenVedu(HI_VOID)
{
	...
	g_smmu_err_mem.RdAddr = MEM_SMMU_START_ADDR0.u32StartPhyAddr;//config alloc phyaddr,in order system don't dump
	g_smmu_err_mem.WrAddr = MEM_SMMU_START_ADDR1.u32StartPhyAddr;
